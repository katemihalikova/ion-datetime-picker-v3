...
export class DatetimePickerDirective {
  ...
  constructor(
    ...
    console.log('DatetimePickerDirective', this.input, this);
  }

  private open() {
    console.log('DatetimePickerDirective.open() A');
    ...
    console.log('DatetimePickerDirective.open() B', pickerOptions);
    ...
    console.log('DatetimePickerDirective.open() C', pickerOptions);
    ...
    console.log('DatetimePickerDirective.open() D', picker);
  }
}
