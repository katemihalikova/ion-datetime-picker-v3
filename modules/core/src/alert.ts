...
import { AlertButton, App, Config, NavOptions, ViewController } from "ionic-angular";
...
export class DatetimePickerAlert extends ViewController {
  ...
  constructor(app: App, opts: DatetimePickerAlertOptions = {}, config: Config) {
    ...
    super(DatetimePickerAlertComponent, opts, "");
    this.app = app;
    this.isOverlay = true;
  ...
  public addButton(button: AlertButton | string): this {
